...
function limpiarDatos() {
    document.getElementById('id_articulo').innerText = "";
    document.getElementById('nombre_articulo').innerText = "";
    document.getElementById('cantidad_articulo').innerText = "";
    document.getElementById('fecha_delPedido').innerText = "";
}
